...
const products = [
    ...
    },
    {
        ...
        shortUrl: 'dev.bluelabtech.space',
        description:
            'A full-featured developer toolkit platform offering a suite of productivity tools — PDF utilities, code tools, and developer-focused converters — wrapped in a sleek, modern dashboard interface.',
    ...
    },
    {
        ...
        shortUrl: 'sheethub.bluelabtech.space',
        description:
            'A smart spreadsheet collaboration hub that lets users create, manage, and work with spreadsheets online. Built with a focus on real-time usability, clean UX, and powerful data handling capabilities.',
        tech: ['React', 'JavaScript', 'Node.js', 'CSS'],
        features: ['Online spreadsheet editor', 'Clean & intuitive UI', 'Data management tools', 'Real-time usability'],
        emoji: '🗂️',
